...
function updateTimer() {
  const targetDate = new Date("january 18, 2025 20:09:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '542975941796'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542975941796'; // Número para el primer botón
